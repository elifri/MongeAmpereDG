...
\begin{proof}
	...
	\right) ^{\frac 1 2} \nonumber \\
	\leq & \maxTriple {\LTwonorm{A}}{2} {\sup_{e \in \edges }\LTwonormE{\average A}} \eNorm \varphi \eNorm v  \leq \label{eq: exact estimate boundedness} % \eNorm{A} \eNorm{\varphi}
	\end{align}
\end{proof}

The next step in our analysis considers the stability of the SIPG method. To do we first need to define a norm measuring elements in $V'$
