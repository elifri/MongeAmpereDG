\todo{introduction}
In this we develop a Picard iteration aiming to solve the \MA equation. To the author's knowledge this is the first try to apply the Picard linearisation on the \MA equation. 
