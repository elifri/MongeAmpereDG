...
\[
	...
	f = \pi \delta_{x_0}
\]
defines the third example. \todo{cone only aleksandrov solution}
\end{test}
...
\begin{figure}[h!]
\centering
	\includegraphics[width = 0.95\textwidth, height = 0.41\textheight]{../../FEniCS/diagrams/MA1_Neilan_l2.pdf}
...
\begin{figure}[h!]
\centering
	\includegraphics[scale =0.5]{../../FEniCS/diagrams/MA1_Neilan_h1.pdf}
...
\begin{figure}[h!]
	\includegraphics[scale=0.5]{../../FEniCS/diagrams/MA1_Neilan_GradJump_l2.pdf}
	\caption{$L^2$ errors for test case \ref{test smooth} and additional gradient jump penalty}
	\label{fig: l2 errors test 1 jump}
\end{figure}

\begin{figure}[h!]
	\includegraphics[width = 0.95\textwidth, height = 0.41\textheight]{../../FEniCS/diagrams/MA1_Neilan_GradJump_h1.pdf}
