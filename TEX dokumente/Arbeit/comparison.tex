...
Looking at the Picard iteration in \eqref{eq:fixed point iteration} we see that we aim to solve the linearisation of the \MA equation at the point $u^i$ in every step.\\
