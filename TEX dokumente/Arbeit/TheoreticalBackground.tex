...
\begin{align*}
  ...
  = &  \average \varphi \jump { A \nabla v \cdot n }+ \jump \varphi \average{ A \nabla v \cdot n }
\end{align*}
...
and 
\begin{align}
	l(\varphi) =&- \sum\limits_{T \in \triang} \int_T \varphi 2f -\sum\limits_{e \in \edgesb}\int_{e} u_0 A \nabla \varphi \cdot n.
\end{align} 
...
todo{ Kommentar zur Implementation wegen Vorzeichen für Kantenterme}
\newpage
