...
\begin{align*}
	...
	= \myIntX  \Omega { \varphi f } \qquad \forall \varphi \in H_0^1(\Omega). %\label{eq: FE integration by parts}
\end{align*}
...
%	T v &= 0 \qquad %&&\text{ on } \partial \Omega.    \label{eq: poisson homogeneous bc}
\end{align}
