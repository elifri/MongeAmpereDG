...
Another crux of the implementation are of course the face terms. When implementing each face has to be naturally processed only once. One has to take that the normal derivatives are stored always with respect to 
