...
There are two points in favor of those schemes. First, because of their simplicity finite difference schemes are widely used in \quoting{application areas}. Furthermore Barles and Souganidis set up a general framework to analyse finite difference schemes for fully nonlinear elliptic PDEs satisfying a comparison principle \cite{BS1991}. In particular this work reduces the convergence analysis for monotone schemes to the verification of stability and consistency.
