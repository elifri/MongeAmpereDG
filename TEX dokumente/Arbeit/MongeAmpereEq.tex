...
Because of their simplicity methods of the first category, i.e. the finite difference schemes are widely used in "application areas". The term Direct refers to the fact that these schemes directly approximate the in \eqref{MA eq} occurring derivatives. 
...
\todo{framework barles souganidis}
