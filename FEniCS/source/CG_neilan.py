...
##perform once solving neilans equations
...
# Gateaux derivative in dir. of u
  ...
  #find out parameters of newton solver
  print prm['newton_solver'].keys()
  print prm['newton_solver'].option_string()
...
if __name__ == "__main__":
  ...
  #fourth test: rhs=2/(2-|x|^2)
  class rhs(Expression):
    def eval(self, v, x):
#       v[0] = (1 + x[0]*x[0]+x[1]*x[1]) * exp(x[0]*x[0]+x[1]*x[1])
  ...
  fileprefix = 'temp'+str(deg)+str(deg_hessian)+'_'
