...
//  std::cerr << "   factor " << factor_ << " blur coeff " << blurCoeff_ << std::endl;
...
//  std::cerr << "      u " << u << "image_smooth " << imageSmooth_._cubic_atXY(fx,fy) << " " << image_._cubic_atXY(fx,fy)<< std::endl;
}
