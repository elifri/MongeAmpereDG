...
#ifndef SRC_LOCALFUNCTIONS_LOCALBASIS_HH_
#define SRC_LOCALFUNCTIONS_LOCALBASIS_HH_
...
namespace Dune
{
  ...
  /**@ingroup LocalBasisInterface
         ...
         \nosubgrouping
   */
  template<class DF, int n, class D, class RF, int m, class R, class J, class H, int dorder=0>
...
#endif /* SRC_LOCALFUNCTIONS_LOCALBASIS_HH_ */
