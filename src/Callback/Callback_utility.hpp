...
typedef function_type<SolverConfig::DomainType, SolverConfig::value_type> MA_function_type;
typedef function_type<SolverConfig::DomainType, SolverConfig::DomainType> derivative_function_type;
typedef const_function_type<SolverConfig::DomainType, SolverConfig::RangeType> MA_const_function_type;

typedef function_type<SolverConfig::DomainType, SolverConfig::HessianRangeType> MA_derivative_function_type;
...
struct General_functions{
	static void easy_convex_polynomial(const SolverConfig::DomainType & x, SolverConfig::value_type & u)
	{
		u = (x[0]*x[0]+x[1]*x[1])/2.;
	}

	static void easy_convex_polynomial_plus_one(const SolverConfig::DomainType & x, SolverConfig::value_type & u)
	{
	...
	static void constant_one(const SolverConfig::DomainType & x, SolverConfig::value_type & u)
	{
		u = 1;
	}
