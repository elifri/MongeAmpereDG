...
enum {
	...
	degreeSigmadim = 2, // polynomial degree for entries in Hessian
	shapeSigmadim = 6, //no. of basis functions per Hessian entry per element
#endif
...
/////stores a coefficients for every entry of a diffusionmatrix such polynomials of degree shapeSigmdim can be represented
typedef Eigen::Matrix<constant_diffusionmatrix_type, shapeSigmadim, 1> Ediffusionmatrix_type;
