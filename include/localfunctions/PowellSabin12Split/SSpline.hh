...
namespace Dune
{
  ...
  public:
    ...
    struct Traits{
      ...
      typedef PS12SSplineGlobalCoefficients<Geometry> Coefficients;
      ...
      typedef PS12SSplineGlobalCoefficients<Geometry> LocalCoefficientsType;
    };

//    PS12SSplineFiniteElement(): geo_(*(new Geometry)){}

    PS12SSplineFiniteElement (const Geometry& geometry) : geo_(geometry), basis_(geo_), coefficients_(geo_), interpolation_(geo_)
    {}
