...
#include "pktrace2dlocalbasis.hh"
#include "pktrace2dlocalcoefficients.hh"
#include "pktrace2dlocalinterpolation.hh"
...
namespace Dune
{
  ...
  public:
    ...
    /** \todo Please doc me !
     */
    PkTrace2DLocalFiniteElement (int variant) : coefficients(variant)
    {
      gt.makeTriangle();
    }
     ...
     */
    PkTrace2DLocalFiniteElement (const unsigned int vertexmap[3]) : coefficients(vertexmap)
    {
      gt.makeTriangle();
    }
